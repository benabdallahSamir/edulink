  ...
  return (
    <div className="relative w-full md:w-[50%] h-[400px] md:h-[700px] rounded-[36px] overflow-hidden mb-5 md:mb-0">
      ...
      <div className="relative flex flex-col items-start justify-end h-full p-4 md:p-7 w-full">
        <h2 className="text-gray-400 font-gilroy font-regular text-xl md:text-2xl leading-8 md:leading-10">
          ADO
        </h2>
        <h1 className="text-white text-2xl md:text-3xl font-gilroy font-medium mb-3 md:mb-5">
          how your pc is working , <br /> let's learn
        </h1>
      </div>
    </div>
  );
